...
(function () { 
    ...
    */
    TextIconOverlay.prototype.initialize = function(map){
		...
		this._domElement.className = 'tomcat-cluster-icon';
        this._updateCss();    
        this._updateText();
    ...
    */
    TextIconOverlay.prototype._updateText = function(){
        if (this._domElement) {
            this._domElement.innerHTML = '<div class="tomcat-cluster-icon-text">' + this._text + '</div>';
        }
    };
    ...
    */
     ...
     * <br />"<b>point</b> : {BMapGL.Point} 最新添加上的节点BMapGL.Point对象

     * <br />"<b>pixel</b>：{BMapGL.pixel} 最新添加上的节点BMapGL.Pixel对象
